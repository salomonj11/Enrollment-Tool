...
import {
  createOneCampus,
  updateCampus,
} from '../store/reducers/campusReducer';
...
const CampusForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (newCampus) {
      dispatch(createOneCampus({ ...campus }));
  ...
  return (
    <form className="form flex-column">
      <h2>{newCampus ? 'Create New Academy' : 'Update Campus'}</h2>
      {submitted && valid ? (
